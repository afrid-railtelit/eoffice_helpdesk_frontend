...
function ManageEmployeeTableToolbar({
  table,
  setColumnsToSearch,
}: {
  table: Table<any>;
  ...
  return (
    <div className="flex flex-row items-center gap-3">
      <Input
        ...
        about="Search By Employee code,Email id,Name or Mobile number..."
        className="lg:w-[20vw]"
        placeholder="Search By Employee code,Email id,Name or Mobile number..."
        noErrorMessage={true}
        onClear={() => {
          setSearchedValue("");
